...
public class LoginController implements Initializable {
    ...
    private void doLogin() {
        ...
        if (loginField.getText().equals("") || passField.getText().equals("")) {
            ...
            try {
                app.notey.send(Const.LOGIN);
                app.notey.waitForInt();

                app.notey.send(loginField.getText());
                app.notey.waitForInt();

                app.notey.send(passField.getText());

                int res = app.notey.waitForInt();
    ...
    private void doReg() {
        ...
        if (loginField.getText().equals("") || passField.getText().equals("")) {
            ...
            try {
                app.notey.send(Const.REGISTRATION);
                app.notey.waitForInt();
